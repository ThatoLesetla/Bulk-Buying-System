            ...
            <thead>
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            if ($result) {
                                ...
                                $avgOrderPrice = $numOrders / $total;
                            }
                            ?>
                            <h5 id="h5.-bootstrap-heading">Number of orders<a class="anchorjs-link" href="#h5.-bootstrap-heading"><span class="anchorjs-icon"></span></a></h5>
                        </td>
                        <td class="type-info w3l"><?php echo $numOrders ?> </td>
                    </tr>
                    <tr>
                        <td>
                            <?php
                            ...
                            if ($result1) {
                                ...
                                if (mysqli_num_rows($result1) > 0) {
                                    $numCustomers = mysqli_num_rows($result1);
                                }
                            }
                            ?>
                            <h5 id="h5.-bootstrap-heading">Number of customers<a class="anchorjs-link" href="#h5.-bootstrap-heading"><span class="anchorjs-icon"></span></a></h5>
                        </td>
                        <td class="type-info w3l"><?php echo $numCustomers ?> </td>
                    </tr>
                        ...
                        <td>
                            ...
                            if ($result3) {
                                ...
                                if (mysqli_num_rows($result3) > 0) {
                                    $numProducts = mysqli_num_rows($result3);
                                }
                            }
                            ?>
                            <h5 id="h5.-bootstrap-heading">Number of products<a class="anchorjs-link" href="#h5.-bootstrap-heading"><span class="anchorjs-icon"></span></a></h5>
                        </td>
                        <td class="type-info w3l"><?php echo $numProducts ?> </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <?php
                            $query4 = "SELECT * FROM vendororder";
                            $result4 = mysqli_query($db, $query4);

                            if ($result4) {

                                if (mysqli_num_rows($result4) > 0) {
                                    $numProducts = mysqli_num_rows($result4);
                                }
                            }
                            ?>
                            <h5 id="h5.-bootstrap-heading">Number of products<a class="anchorjs-link" href="#h5.-bootstrap-heading"><span class="anchorjs-icon"></span></a></h5>
